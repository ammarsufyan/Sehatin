...
// Load the question
var questionJson = JSON.parse($.getJSON({'url': "/static/js/tests/mindfulness/questions.json", 'async': false}).responseText);
...
getNewQuestion = () => {
    ...
    if(availableQuestions.length === 0 ) {
        ...
        var form = $('<form action="/tests/health/mindfulness/result" method="post">' +
