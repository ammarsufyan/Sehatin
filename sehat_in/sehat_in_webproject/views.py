        ...
        if password_reset_form.is_valid():
            ...
            if associated_users.exists():
                for user in associated_users:
                    ...
                    plaintext = template.loader.get_template('password/reset-email.txt')
                    htmltemp = template.loader.get_template('password/reset-email.html')
                    c = {
                    "email":user.email,
                    ...
                    try:
                        msg = EmailMultiAlternatives(subject, text_content, 'Tim Sehatin <contact.sehatin@gmail.com>', [user.email], headers = {'Reply-To': 'contact.sehatin@gmail.com'})
